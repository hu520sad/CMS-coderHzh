...
<template>
	<div class="content">
		<div class="header-list">
			<h2 style="font-size: 20px">部门列表</h2>
			<el-button type="primary" @click="newUser">新建部门</el-button>
		</div>
		<div class="table">
			<el-table :data="pageList" border style="width: 100%">
				<el-table-column align="center" type="selection" width="50px" />
				<el-table-column align="center" type="index" width="60px" label="序号" />
				<el-table-column prop="name" label="部门名称" align="center" width="150px" />
				<el-table-column prop="leader" label="部门领导" align="center" width="150px" />
